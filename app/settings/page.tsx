...
export default function SettingsPage() {
  const [notifs, setNotifs] = useState({ mentions: true, planets: true, digest: false })

  const [profileImage, setProfileImage] = useState<string | undefined>(() => {
    if (typeof window !== 'undefined') {
      return localStorage.getItem('qllose-profile-image') || undefined
    }
  ...
  function handleImageUpload(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    reader.onload = () => {
      ...
      localStorage.setItem('qllose-profile-image', image)
    }
        ...
        <SettingsCard icon={Bell} title="Notifications">
          <div className="flex flex-col divide-y divide-border">
            <Toggle
              ...
              onChange={() => setNotifs((n) => ({ ...n, mentions: !n.mentions }))}
            />

            <Toggle
              label="Planet activity"
              description="Updates from planets you have joined."
              checked={notifs.planets}
              onChange={() => setNotifs((n) => ({ ...n, planets: !n.mentions }))}
            />
            ...
            <Toggle
              ...
              onChange={() => setNotifs((n) => ({ ...n, digest: !n.digest }))}
            />
          </div>
        </SettingsCard>
        ...
        <SettingsCard icon={Palette} title="Appearance">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Qllose is crafted for deep space. Dark mode only.
              </p>
            </div>
